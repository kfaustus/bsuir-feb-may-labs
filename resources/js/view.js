import * as placeholder from '../img/placeholder.jpg';
export default class View {
  ...
  createNewsItem(itemData) {
    ...
    const url = itemData.urlToImage || placeholder.default;
    newsClone.querySelector('.news__meta-photo').style.backgroundImage = `url("${url}")`;
